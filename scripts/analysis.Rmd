...
edges <- read_csv("repos/DirectionalNK/scripts/edges_6.csv")

# Read in fitnesses from reproduction fitness landscape
repro_fits <- read_csv("repos/DirectionalNK/scripts/repro_fits_1963.csv")

# Read in fitnesses from shock landscape
shock_fits <- read_csv("repos/DirectionalNK/scripts/shock_fits_1963.csv")
...
pop <- read_table("repos/DirectionalNK/src/outs/popt-N6-k1-s1963-r0.001-Gradual.txt",skip = 3)
